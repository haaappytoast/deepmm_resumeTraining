if __name__ == '__main__':
    ...
    # model_path = task_path + "/stats/20221115_walk5202241"
    model_path = task_path + "/stats/20221127_yrs"
    ...
    # model.load_state_dict(torch.load(model_path + "/iter49999.pt"))
            ...
            #     }, filename+"/full_"+ str(iteration) + '.pt')    

    model.load_state_dict(torch.load(model_path+"/full_2.pt")['model_architecture_state_dict'])
    model.load_state_dict(torch.load(model_path+"/full_2.pt")['model_architecture_state_dict'])
    model.cuda()
