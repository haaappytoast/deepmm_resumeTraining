...
class RL(object):
    ...
    def collect_samples_vec(self, num_samples, start_state=None, noise=-2.5, env_index=0, random_seed=1):
        ...
        print("\n", "processing time: %f"%(time.time() - start))
    ...
    def save_params(self, filename):
        ...
        print("=================\nsaving parameters of model and optimizers\n=================")
...
if __name__ == '__main__':
    ...
    mode = args.mode
    weight_path = task_path + "/stats/" + args.weight
    ...
    ppo.model_name = task_path + "/stats/20221127_yrs/"
    ...
    if mode == 'retrain':
        # # initialize model network and optimizers
        # num_inputs = env.observation_space.shape[0]
        # num_outputs = env.action_space.shape[0]
        # ppo.Net = ActorCriticNet(num_inputs, num_outputs, [128, 128])
    ...
    ppo.collect_samples_multithread(start_iteration_number)
